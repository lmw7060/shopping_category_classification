...
X_train, X_test, Y_train, Y_test = np.load('./shopping_data_max_29_wordsize_10626.npy',allow_pickle=True)
print(X_train.shape,Y_train.shape)
print(X_test.shape,Y_test.shape)

model = Sequential()
model.add(Embedding(10626,300,input_length=29))                     #벡터화하여 의미를 만들어준다 input_dim = 차원의 수를 대입,output_dim = 차원수를 축소
